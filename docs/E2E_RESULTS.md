...
| 20 | archived duplicate → done/skipped, no re-download, no dialog | PASS | queue done in 3375ms skipped=true (already in downloaded archive) |
...
| 22 | reset app data (d69): guarded wipe, bin kept, report matches disk | PASS | queue rows before: 7 (busy: 0)<br>busy-guard: n/a (queue idle)<br>report: jobs=7 history=3 settings=true archive=true customArchive=false<br>after: queue=0 history=0 settings.json=removed downloaded.txt=removed bin kept=true |
