...
| 14 | ctrl+v / F5 | PASS | after ctrl+v: tabs=[{"t":"home","on":true},{"t":"history","on":false},{"t":"settings","on":false}] composerFocused=true<br>F5 on history: rows ipc before/after=3/3, rendered rows=3 |
...
| 20 | archived duplicate → done/skipped, no re-download, no dialog | PASS | queue done in 10204ms skipped=false (no error)<br>archive line appended: soundcloud 293<br>file present: Flickermood [293].mp3<br>re-queue: skipped=true, file untouched=true |
...
| 22 | reset app data (d69): guarded wipe, bin kept, report matches disk | PASS | queue rows before: 6 (busy: 0)<br>busy-guard: n/a (queue idle)<br>report: jobs=6 history=6 settings=true archive=true customArchive=undefined<br>after: queue=0 history=0 settings.json=removed downloaded.txt=removed bin kept=true |
